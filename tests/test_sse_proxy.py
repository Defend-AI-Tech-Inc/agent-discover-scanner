...
class TestSSEProxyCorrelator:
    ...
    def test_sse_proxy_ghost_uses_username_as_process_name(self):
        """process_name of SSE GHOST should come from username field."""
        ...
        assert ghost.process_name == "ml-bot@corp.com"
